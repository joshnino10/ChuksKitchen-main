...
export default function SinglePopularDishes() {
  ...
  const handleAddToCart = () => {
    ...
    addToCart({
      ...
      image: currentDish.SingleImage as ImageSourcePropType,
      quantity: count,
    });
    setCount(0);
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.foodHeader}>
          <Text style={styles.foodName}>{currentDish.Food}</Text>
          <Text style={styles.foodPrice}>{currentDish.Price}</Text>
        </View>
        ...
        <View style={styles.DescriptionContainer}>
          ...
          <Text style={styles.descriptions}>{currentDish.Description}</Text>
        </View>
